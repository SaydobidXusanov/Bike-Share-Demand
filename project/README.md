...
Finally they will submit all their work and write a report detailing which methods provided the best score improvement and why. A template of the report can be found [here](project_report.md).
...
* Proceed with the project within the [jupyter notebook](project_notebook.ipynb).
